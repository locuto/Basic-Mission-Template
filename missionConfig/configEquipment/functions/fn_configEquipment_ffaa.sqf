//=======================================================================================================//
// File: fn_configEquipment_ffaa.sqf                                                                     //
// Author: TheMagnetar                                                                                   //
// Version: 1.0                                                                                          //
...
switch (_unitRole) do {
    // Platoon Leader.
    case "pl": {
        #include "ffaa\bmt_pl_platoonLeader.sqf"
    };

    // Platoon Sergeant.
    case "psg": {
         #include "ffaa\bmt_psg_platoonSergeant.sqf"
    };

    // Platoon Radiotelephone Operator.
    case "rto": {
       #include "ffaa\bmt_rto_platoonRadiotelephoneOperator.sqf"
    };

    // Forward Observer.
    case "fo": {
        #include "ffaa\bmt_fo_forwardObserver.sqf"
    };

    // Joint Terminal Attack Controller.
    case "jtac": {
        #include "ffaa\bmt_jtac_jointTerminalAttackController.sqf"
    };

    // Platoon Medic.
    case "me": {
        #include "ffaa\bmt_me_platoonMedic.sqf"
    };

    // Squad Leader.
    case "sl": {
        #include "ffaa\bmt_sl_squadLeader.sqf"
    };

    // Team leader.
    case "tl": {
        #include "ffaa\bmt_tl_teamLeader.sqf"
    };

    // Rifleman.
    case "rfl": {
        #include "ffaa\bmt_rfl_rifleman.sqf"
    };

    // Rifleman with AT4.
    case "rflat": {
        #include "ffaa\bmt_rflat_riflemanAntiTank.sqf"
    };

    // Rifleman with UAV.
    case "rfluav": {
        #include "ffaa\bmt_rfluav_riflemanUAV.sqf"
    };

    // Grenadier.
    case "gr": {
        #include "ffaa\bmt_gr_grenadier.sqf"
    };

    // Automatic Rifleman.
    case "ar": {
        #include "ffaa\bmt_ar_automaticRifleman.sqf"
    };

    // Assitant Automatic Rifleman.
    case "aar": {
        #include "ffaa\bmt_aar_assistantAutomaticRifleman.sqf"
    };

    // Designated Marksman.
    case "dm": {
        #include "ffaa\bmt_dm_designatedMarksman.sqf"
    };

    // Machine Gunner.
    case "mg": {
        #include "ffaa\bmt_mg_machineGunner.sqf"
    };

    // Assitant Machine Gunner.
    case "amg": {
        #include "ffaa\bmt_amg_assistantMachineGunner.sqf"
    };

    // Anti-Tank.
    case "at": {
        #include "ffaa\bmt_at_antiTank.sqf"
    };

    // AT Ammo handler.
    case "aat": {
        #include "ffaa\bmt_aat_assistantAntiTank.sqf"
    };

    // Anti-Aircraft gunner.
    case "aa": {
        #include "ffaa\bmt_aa_antiAircraftGunner.sqf"
    };

    // Anti-Aircraft Assitant.
    case "aaa": {
        #include "ffaa\bmt_aaa_assistantAntiAircraftGunner.sqf"
    };

    // Engineer.
    case "en": {
        #include "ffaa\bmt_en_engineer.sqf"
    };

    // Explosives Specialist.
    case "exp": {
        #include "ffaa\bmt_exp_explosivesSpecialist.sqf"
    };

    // Sniper.
    case "sn": {
        #include "ffaa\bmt_sn_sniper.sqf"
    };

    // Spotter.
    case "sp": {
        #include "ffaa\bmt_sp_spotter.sqf"
    };

    // Diver Squad Leader.
    case "divsl": {
        #include "ffaa\bmt_divsl_diverSquadLeader.sqf"
    };

    // Diver Medic.
    case "divme": {
        #include "ffaa\bmt_divme_diverMedic.sqf"
    };

    // Diver Explosives Specialist.
    case "divexp": {
        #include "ffaa\bmt_divexp_diverExplosivesSpecialist.sqf"
    };

    // Diver.
    case "div": {
        #include "ffaa\bmt_div_diver.sqf"
    };

    // Helicopter pilot.
    case "hplt": {
        #include "ffaa\bmt_hplt_helicopterPilot.sqf"
    };

    // Jet pilot.
    case "jplt": {
        #include "ffaa\bmt_jplt_jetPilot.sqf"
    };

    // Combat crew
    case "ccrw": {
        #include "ffaa\bmt_ccrw_combatCrew.sqf"
    };
